...
export default function Login() {
  ...
  const handleNextPress = () => {
    ...
    //   return;
    // }
    navigation.navigate('StudentsStack', {screen: 'BottomTab'});
    // setIsLoading(true);
...
{isLoading && (
      ...
      onPress={() =>     navigation.navigate('GuardianAuthStack', {screen: 'Register'})
    }
      >
      <Text style={{...FONTS.body4, color:COLORS.darkpurple,}}>Switch to Guardian</Text>
