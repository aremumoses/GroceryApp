  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.white, paddingBottom: SIZES.h1 }}>
      ...
      <View style={{ marginHorizontal: SIZES.body3 }}>
        ...
        >
          The following classroom have sent you an invite, click to join now
        </Text>
        ...
        >
          Enter your email address here, you will be added to the classroom(s) you selected.
        </Text>
        <Text
          style={{
            marginHorizontal: SIZES.base,
