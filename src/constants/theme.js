...
export const FONTS = {
    navTitle: { fontFamily: 'NunitoSans-Bold', fontSize: SIZES.navTitle, lineHeight: 25 },
    h1: { fontFamily: 'NunitoSans-Bold', fontSize: SIZES.h1, lineHeight: 36 },
    h2: { fontFamily: 'NunitoSans-Bold', fontSize: SIZES.h2, lineHeight: 30 },
    h2a: { fontFamily: 'NunitoSans-Bold', fontSize: SIZES.h2a, lineHeight: 30 },
    h2c: { fontFamily: 'NunitoSans-Bold', fontSize: SIZES.h2c, lineHeight: 30 },
    h3: { fontFamily: 'NunitoSans-Bold', fontSize: SIZES.h3, lineHeight: 22 },
    h3a: { fontFamily: 'NunitoSans-Bold', fontSize: SIZES.h3a, lineHeight: 22 },
    ...
    body1: { fontFamily: 'NunitoSans-Regular', fontSize: SIZES.body1, lineHeight: 22 },
    body2: { fontFamily: 'NunitoSans-Regular', fontSize: SIZES.body2, lineHeight: 22 },
    body3: { fontFamily: 'NunitoSans-Regular', fontSize: SIZES.body3, lineHeight: 22 },
    body3a: { fontFamily: 'NunitoSans-Regular', fontSize: SIZES.body3a, lineHeight: 22 },
    body3b: { fontFamily: 'NunitoSans-Regular', fontSize: SIZES.body3b, lineHeight: 22 },
    ...
    body6: { fontFamily: 'NunitoSans-Regular', fontSize: SIZES.body6, lineHeight: 22 },
    intro: { fontFamily: 'NunitoSans-Regular', fontSize: SIZES.intro, lineHeight: 22 },
};
